...
| 時間 | セクション | 内容 | 進行状況 |
|------|-----------|------|----------|
| 0-15分 | 第1部：基礎理解 | 生成AI概要・プロンプト基本概念 | ✅ 完了 |
| 15-40分 | 第2部：基本原則 | 明確性・構造化・文脈提供の原則 | 🔄 進行中 |
| 40-75分 | 第3部：実践活用 | 授業設計・教材作成・学生サポート・業務効率化 | ⏳ 予定 |
| 75-85分 | 第4部：高度技術 | 高度プロンプト技術 | ⏳ 予定 |
| 85-90分 | 第5部：まとめ | 実践・まとめ | ⏳ 予定 |
